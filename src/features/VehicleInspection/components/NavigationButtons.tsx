  ...
  return (
    <div className="flex justify-between items-center mt-8">
      ...
      <div className="flex gap-2 md:gap-4">
        <button
          type="button"
          className="px-4 md:px-8 py-3 md:py-4 text-gray-600 border-2 border-gray-300 rounded-xl hover:bg-gray-50 transition-all duration-200 active:scale-95 text-base md:text-lg font-medium"
        >
          <span className="hidden sm:inline">รีเซ็ท</span>
